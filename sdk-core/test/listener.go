...
func (o *onAdvancedMsgListener) OnConversationReadStateChanged(readStateInfo string) {
	log.ZInfo(o.ctx, "OnConversationReadStateChanged", "readStateInfo", readStateInfo)
}
