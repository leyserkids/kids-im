...
export declare function updateColumnsFriend(friendUserIDListStr: string, localFriendStr: string): Promise<string>;
export declare function getFriendListCount(): Promise<string>;
export declare function batchInsertFriend(localFriendListStr: string): Promise<string>;
export declare function deleteAllFriend(): Promise<string>;
